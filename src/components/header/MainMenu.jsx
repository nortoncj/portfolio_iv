    ...
    const handleScroll = () => {
      ...
      sections.forEach((section) => {
        ...
        if (window.scrollY >= sectionTop - 120) {
          // Adjust for any offset (e.g., fixed header)
      ...
      <div className="main-container">
        <div className="main-nav-container">
          ...
          <ul className=" nav-main" data-in="fadeInDown" data-out="fadeOutUp">
            <li>
              <Link className="main-nav-link" href="#home">
                Home
              </Link>
            </li>
            <li>
              <Link className="main-nav-link main-active" href="#skills">
                Skills
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link className="main-nav-link" href="#portfolio">
                Portfolio
              </Link>
            </li>
            <li>
              <Link className="main-nav-link" href="#contact">
                Contact
              </Link>
            </li>
          </ul>
